...
- Technologies Used:
- **Flask**: Python web framework for building the backend server. **Bootstrap**: Frontend framework for responsive design and styling. **NewsAPI**: External API for fetching news articles. **Jinja2**: Templating engine for rendering HTML templates with Flask.
